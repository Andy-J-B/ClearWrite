    ...
    <div style={styles.pageContainer}>
      <div style={styles.leftColumn}>
        <div style={styles.square}>
          ...
          <div>
            {grammarChecked.filter(entry => entry.corrections && entry.corrections.length > 0).length > 0 ? (
              grammarChecked
              ...
              <p style={styles.emptyText}>No grammar issues with corrections available.</p>
            )}
          </div>
        )}
